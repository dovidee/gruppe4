...
export default async function About() {
  const { about, person, social } = await getSiteSettings();
    ...
    <Column maxWidth="m">
      ...
      {about.tocDisplay && (
        ...
        >
          <TableOfContents
            structure={structure}
            about={{ tableOfContent: { display: about.tocDisplay, subItems: about.tocSubItems } }}
          />
        </Column>
      )}
        ...
        <Column className={styles.blockAlign} flex={9} maxWidth={40}>
          ...
          {about.intro.display && (
            <Column textVariant="body-default-l" fillWidth gap="m" marginBottom="xl">
              <PortableTextBody value={about.intro.description} />
            </Column>
          )}
